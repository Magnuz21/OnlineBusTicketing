        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">No Tickets Found!!</h1>
                        <p class="fw-light">Be the first person to add one!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to get tickets!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Add Tickets<i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Do you really want to delete this ticket? <strong>This process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
