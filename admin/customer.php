        ...
        <?php
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        ...
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to add a passenger!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="customer">
                ...
                <div id="customer-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Add Passenger Details <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Do you really want to delete these passenger details? <strong>This process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
